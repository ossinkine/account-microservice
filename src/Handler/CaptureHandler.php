...
class CaptureHandler implements MessageHandlerInterface
{
    /**
    ...
    public function __invoke(CaptureMessage $message): void
    {
        ...
        $this->eventDispatcher->dispatch(Events::CAPTURE, new CaptureEvent($message->getUserId(), $message->getAmount()));
    }
}
